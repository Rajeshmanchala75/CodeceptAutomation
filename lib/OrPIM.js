...
async function gridDatatable(fieldname) {
    ...
    I.wait(5)
    I.seeElement("//div[@class='oxd-table-cell oxd-padding-cell']/..//div[text()='" + fieldname + "']");
    let fieldtext = await I.grabTextFrom("//div[@class='oxd-table-cell oxd-padding-cell']/..//div[text()='" + fieldname + "']");
